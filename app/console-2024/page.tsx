...
export default async function AdminPage() {
    ...
    const canManageMembers = role === 'SUPER_ADMIN' || role === 'MEMBER_MANAGER';
    const canManageEvents = role === 'SUPER_ADMIN' || role === 'EVENT_MANAGER';
    const canManageNews = role === 'SUPER_ADMIN' || role === 'NEWS_MANAGER';
        ...
        <div className="min-h-screen bg-background p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    {canManageNews && (
                        <div className="bg-primary-light border border-gray-800 rounded-xl p-6">
                            <h2 className="text-xl font-bold text-white mb-2">Haberler</h2>
                            <p className="text-4xl font-bold text-accent mb-1">{news.length}</p>
                            <p className="text-gray-400 text-sm">Toplam haber sayısı</p>
                        </div>
                    )}
                </div>
